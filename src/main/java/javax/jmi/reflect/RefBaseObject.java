...
public interface RefBaseObject {
	 ...
	 * <p>
	 * If the object's metaobject is unavailable, the return value may be a 
	 ...
	 * <p>
	 * If this object has no containing or aggregating package (i.e. it is the 
	 ...
	 * <p>
	 * If the ignoreLifecycle tag (attached to the package containing the 
     ...
     * <p>
     * If this object is the RefPackage object for an outermost package then 
     ...
     * identifier string.
     * <p>
     * Every MOF object has a permanent, unique MOF identifier associated with 
     ...
     * <p>
     * A MOF implementation must ensure that no two distinct MOF objects within 
     ...
     * <p>
     * When deepVerify is false (i.e., a shallowVerify), the 
     * refVerifyConstraints method checks all constraints on that object and 
     * its properties.
     * <p>
     * When deepVerify is true, the refVerifyConstraints method carries out a 
     ...
     * in its extent.
     * <p>
     * If no constraint is violated, the null value is returned; otherwise, a 
     * list of javax.jmi.reflect.JmiException objects (each representing a 
     * constraint violation) is returned.
     * <p>
     * The Collection returned from the refVerifyConstraints operation has 
