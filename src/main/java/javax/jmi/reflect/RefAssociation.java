...
/**
 * The <tt>RefAssociation</tt> interface provides the metaobject description of 
 * an association. It also provides generic operations querying and updating the 
 * links that belong to the association
 *
...
public interface RefAssociation extends RefBaseObject {
   ...
   * or inaccessible.
   *
   * @param queryEnd RefObject
   * @param queryObject RefObject
   * @return
   */
