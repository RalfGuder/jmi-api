...
public interface RefPackage extends RefBaseObject {
     ...
     * as per “Generation Rules for Parameters” on page 56.
     * 
     ...
     * “literalName”. Note that the type of enumeration is defined by the metamobject 
